...
namespace CMS.DocumentEngine.Types.Fs
{
    ...
    public partial class ContentProvider
    {
        ...
        public static DocumentQuery<Content> GetContent(int nodeId, string cultureName, string siteName)
        {
            return GetContents().OnSite(siteName).Culture(cultureName).WhereEquals("NodeID", nodeId);
        }
